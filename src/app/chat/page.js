                ...
                >
                    <div>
                        ...
                        <p className="text-lg text-slate-500 font-medium max-w-xl">
                            Your personal space for reflection, emotional
                            support, and guided planning.
                        </p>
                    </div>
                </motion.div>
                ...
                <div className="grid gap-8 lg:grid-cols-12 items-start">
                        ...
                        <div className="bg-slate-900 rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl shadow-slate-900/15 sticky top-24">
                            ...
                            <div className="mb-8 relative z-10">
                                ...
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    Need someone to talk to? Our AI companion is
                                    here to help you unpack your thoughts and
                    ...
                    >
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs font-bold bg-[#FEEAC9] text-[#FD7979] px-3 py-1 rounded-full">
                        ...
                        <AnimatePresence>
                            {chats.length > 0 ? (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center justify-between relative z-10">
                                                <div className="flex items-center gap-5">
                                                    ...
                                                    <div>
                                                        <h3 className="font-extrabold text-lg text-slate-800 mb-1 group-hover:text-[#FD7979] transition-colors line-clamp-1">
                                                            {chat.title}
                                                        </h3>
                                ...
                                <motion.div
                                    variants={fadeUp}
                                    className="bg-white rounded-[2.5rem] py-20 px-6 text-center border border-dashed border-slate-200"
                                >
                                    <Bot
                                        size={56}
                                    ...
                                    <p className="text-slate-500 max-w-md mx-auto">
                                        ...
                                        yet. Click the "New Conversation" button
